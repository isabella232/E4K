...
impl http_common::server::Route for Route {
    ...
    fn from_uri(
        ...
        if path != crate::uri::SELECT_LIST_REGISTRATION_ENTRIES {
            return None;
        }
        Some(Route {
    ...
    type PostBody = common_admin_api::select_list_registration_entries::Request;
    async fn post(self, body: Option<Self::PostBody>) -> http_common::server::RouteResponse {
        ...
        let api = &mut *api;
        let res = api.select_list_registration_entries(body).await;
